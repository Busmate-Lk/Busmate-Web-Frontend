      ...
      <div className="flex items-center justify-between w-full">
        <div>
          {pageTitle ? (
            ...
            <>
              <h1 className="text-2xl font-bold text-gray-900">Good morning, TimeKeeper!</h1>
              <p className="text-slate-600">Welcome back to BUSMATE LK Schedule Management</p>
            </>
          )}
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 px-2 py-1 rounded-md">
            ...
            <div className="text-right">
              <div className="text-sm font-medium text-gray-900">TimeKeeper User</div>
              <div className="text-xs text-slate-500">Schedule Manager</div>
            </div>
