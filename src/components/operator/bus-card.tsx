      ...
      <div className="p-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 mt-3">
            <Link href="/operator/busSeatView" className="flex-1">
              <button className="w-full inline-flex items-center justify-center rounded-md bg-white px-3 py-1.5 text-xs font-medium text-blue-700 border border-blue-700 transition-colors">
                View Details
              </button>
            </Link>
            <Link href="/operator/busLocation" className="flex-1">
              <button className="w-full inline-flex items-center justify-center rounded-md bg-blue-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-blue-700 transition-colors">
                Track Bus
              </button>
            </Link>
          </div>
