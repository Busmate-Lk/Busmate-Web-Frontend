...
export function Header({ pageTitle, pageDescription }: HeaderProps) {
  ...
  // Sample notifications for operator
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      title: 'Route Assignment',
      message: 'You have been assigned to Route #45 Colombo-Galle',
      time: '5 minutes ago',
      type: 'info',
      redirectUrl: '/operator/routes',
      isRead: false
    },
    {
      id: '2',
      title: 'Bus Maintenance',
      message: 'Bus #LK-2456 requires scheduled maintenance',
      time: '1 hour ago',
      type: 'warning',
      redirectUrl: '/operator/buses',
      isRead: false
    },
    {
      id: '3',
      title: 'Schedule Update',
      message: 'Morning schedule has been updated',
      time: '2 hours ago',
      type: 'success',
      redirectUrl: '/operator/schedules',
      isRead: true
    }
  ])
            ...
            >
              ...
              <div className="hidden md:block text-left">
                ...
                <div className="text-xs text-slate-500">
                  {user ? getRoleDisplayName(user.user_role) : 'Fleet Operator'}
                </div>
              </div>
                ...
                <div className="px-4 py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{user?.email || "operator@busmate.lk"}</p>
                    </div>
                  </div>
                </div>
