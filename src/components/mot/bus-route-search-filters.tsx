...
interface BusRouteSearchFiltersProps {
  searchTerm: string;
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4 flex-1">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              placeholder="Search by route name, route number, or operator..."
              value={searchTerm}
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none px-4 py-2 pr-8 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white overflow-hidden"
            >
