...
import { Calendar, CheckCircle, XCircle, Clock, AlertCircle, MapPin, Users } from 'lucide-react';
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-1">
            ...
            {stats.pendingTrips.change && (
              <p className="text-xs text-yellow-600 mt-1">{stats.pendingTrips.change}</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-1">
            ...
            {stats.inTransitTrips.change && (
              <p className="text-xs text-orange-600 mt-1">{stats.inTransitTrips.change}</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-1">
            ...
            {stats.tripsWithPsp.change && (
              <p className="text-xs text-purple-600 mt-1">{stats.tripsWithPsp.change}</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-1">
            ...
            {stats.tripsWithBus.change && (
              <p className="text-xs text-indigo-600 mt-1">{stats.tripsWithBus.change}</p>
            )}
          </div>
        </div>
      </div>
